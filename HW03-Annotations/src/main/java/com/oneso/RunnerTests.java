...
public class RunnerTests {
    ...
    public void run(Collection<? extends Class<?>> classes) {
        ...
        for(Class<?> aClass : classes) {
            ...
            if(!methodMap.containsKey(BEFORE_ALL) || callMethod(methodMap.get(BEFORE_ALL), null, false)) {
        ...
        for(Method method : methods) {
            ...
            if(instance.isPresent()) {
                ...
                if(method.isAnnotationPresent(Test.class)) {
                    if(!beforeAfter.containsKey(BEFORE) || callMethod(beforeAfter.get(BEFORE), instance.get(), false)) {
